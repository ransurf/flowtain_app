...
import com.example.flowtain.MainActivity
import com.example.flowtain.R
import com.example.flowtain.TimerNotificationActionReceiver
...
//        }
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long) {
            ...
            stopIntent.action = TimerActionTypes.STOP.value
            val stopPendingIntent = PendingIntent.getBroadcast(context,
                0, stopIntent, PendingIntent.FLAG_UPDATE_CURRENT)

            val pauseIntent = Intent(context, TimerNotificationActionReceiver::class.java)
            pauseIntent.action = TimerActionTypes.PAUSE.value
        ...
        fun showTimerPaused(context: Context) {
            ...
            resumeIntent.action = TimerActionTypes.START.value
